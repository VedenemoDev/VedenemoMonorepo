...
public final class OwnershipAssociation extends Versionable implements Association {
    ...
    public AssociationKind kind() {
        return AssociationKind.OWNERSHIP;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof OwnershipAssociation that)) {
            return false;
        }
